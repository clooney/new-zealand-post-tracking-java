# New Zealand Post Tracking API For Java
New Zealand Post Tracking API and webhook make it easy to integrate New Zealand Post Tracking function into your own project. Support APIs Client Libraries for java

### API key

In order to use this API, you need to generate a New Zealand Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use New Zealand Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [New Zealand Post Tracking API](https://www.trackingmore.com/new-zealand-post-tracking.html)  to:

   *   Get New Zealand Post realtime tracking info of muti-carriers in one integration
   *   Provide New Zealand Post shipment tracking experience like Amazon
   *   Push New Zealand Post notifications of package update with webhook
   *   Verify New Zealand Post delivery exception before it is too late
